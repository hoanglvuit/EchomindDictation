...
export default function GrammarMCQQuestion({ item, onAnswer, onEdit, onDelete }) {
    ...
    return (
        <div className="animate-fade-in space-y-5">
            ...
            {resolved && (
                <div className="p-4 rounded-xl bg-indigo-50/60 border border-indigo-100 animate-fade-in mt-4 relative group">
